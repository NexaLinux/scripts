...
os.system("dpkg -s curl >/dev/null 2>&1 || sudo apt install -y curl")
...
os.system("sudo apt update && sudo apt install -y brave-browser")
os.system("apt remove -y --noconfirm plymouth")
